import { BuyCarTranslation } from "./components/BuyCar";
...
export const translations = {
 ...
 "backToBiddings": "Back to Biddings",
    ...
    "issuedByCNE": "Issued by Car Network Europe",
    "download": "Download",
    ...
    "issuedAt": "Issued At",
    "dueAt": "Due At",
    "uploadFinalInvoice": "Upload Final Invoice & Documents",
    "finalInvoicePDF": "Final Invoice (PDF)",
    "carDocumentsPDF": "Car Documents (PDF)",
    "ascriptionCode": "Ascription Code",
    "uploadAll": "Upload All",
    "uploading": "Uploading...",
    "fillAllFields": "Please fill all fields and upload files.",
    "uploadSuccess": "Documents uploaded successfully!",
    "paymentStatus": "Payment Status",
    "invoicePaid": "Invoice has been paid",
    "pendingPayment": "Payment pending from Car Network Europe",
    "paid": "Paid",
    "paymentDueIn48h": "Payment due within 48 hours after car delivery.",
    "autoArchiveNote": "This order will be automatically archived 24 hours after delivery if no damage is reported by the buyer.",
  "award": {
...
"backToDetails": "Back to Car Details",
  ...
  "companyProfile": "Company Profile",
     ...
     blocks:{
      ...
      "myFavorites": "My Favorites",
      "orderHistory": "Order History",
      "amountToPay": "Amount to Pay (Won Auctions)",
      "amountToReceive": "Amount to Receive (Sold Cars)",
      "myAuctions": "My Auctions",
      "myAuctionsDesc": "Direct overview of all vehicles currently listed online.",
      "myAuctionsBids": "Show the bids per vehicle.",
      "myAuctionsWarning": "⚠️ Do not use the same layout as the \"Buy\" section.",
      "totalVehicles": "Total Vehicles",
      "myBids": "My Bids",
      "myBidsDesc": "Overview of all vehicles the company has placed bids on.",
      "myBidsPerBranch": "Must be shown per branch, not per dealer group.",
      "totalBids": "Total Bids",
      "myFavorites": "My Favorites",
      "myFavoritesDesc": "Overview of all cars marked as favorites.",
      "totalFavorites": "Total Favorites",
      "orderHistory": "Order History",
      "orderHistoryDesc": "Overview of all purchases.",
      "viewInvoices": "View invoices.",
      "viewAttachedDocs": "View attached documents (file names editable).",
      "totalPurchases": "Total Purchases",
      "amountToPay": "Amount to Pay (Won Auctions)",
      "amountToPayDesc": "Overview of won auctions.",
      "amountToPayUnpaid": "Show the total amount still unpaid, but already won.",
      "totalAmountToPay": "Total Amount to Pay",
      "amountToReceive": "Amount to Receive (Sold Cars)",
      "amountToReceiveDesc": "Overview of sold vehicles.",
      "amountToReceiveOutstanding": "Show the total amount still to be paid out.",
      "totalAmountToReceive": "Total Amount to Receive"


     },
       "goToMyAuctions": "Navigating to My Auctions...",
    "goToMyBids": "Navigating to My Bids...",
    "goToMyFavorites": "Navigating to My Favorites...",
    "goToOrderHistory": "Navigating to Order History...",
    "goToAmountToPay": "Navigating to Amount to Pay...",
    "goToAmountToReceive": "Navigating to Amount to Receive...",
    "backToOverview": "Back to Overview",
    "downloadReport": "Download Report",
    "companyProfile": "Company Profile & Latest News",
        "manageProfile": "Manage your business information and stay updated with platform news.",
  ...
  "filter":{
      ...
      "mileageFrom": "Mileage From (km)",
      "mileageTo": "Mileage To (km)",
      "mileage": "Mileage",
      "sortBy": "Sort By",
      "clearAll": "Clear All"
    },
  "status": {
    ...
    "sort": {
      "dateSoldNewest": "Sale Date: Newest",
      "dateSoldOldest": "Sale Date: Oldest",
      "newest": "Newest",
      "oldest": "Oldest",
      "mileageLow": "Mileage: Low to High",
      "mileageHigh": "Mileage: High to Low",
       "bidAmountHigh": "Bid Amount: High to Low",
      "bidAmountLow": "Bid Amount: Low to High",
      "priceHigh": "Price: High to Low",
      "priceLow": "Price: Low to High",
         "dateDelivered": "Date Delivered",
      "dateClosed": "Date Closed",
        "deadlineSoonest": "Payment Deadline: Soonest",
      "deadlineLatest": "Payment Deadline: Latest",
      "amountHigh": "Amount: High to Low",
      "amountLow": "Amount: Low to High",
    },
     "amountToReceive": {
      "totalOutstanding": "Total Amount Still to be Paid Out",
      "outstandingDescription": "This is the sum of all amounts still to be received for vehicles you have sold.",
      "car": "Car",
      "details": "Details",
      "status": "Status",
      "payout": "Payout",
      ...
      "resultsFound": "sold vehicles found",
      "noSalesDescription": "You have not sold any vehicles yet, or all payouts are processed."
    },
    "activeFilters": "Active Filters",
    "resultsFound": "results found",
    "noResults": "No cars found",
    ...
    "resetFilters": "Reset Filters",
     "orderHistory": {
      "noHistoryDescription": "There are no completed purchases yet.",
      "car": "Car",
      "details": "Details",
      "status": "Status",
      "buyer": "Buyer",
      ...
      "ascriptionCode": "Ascription Code",
      "view": "View",
      "invoiceNotAvailable": "Invoice",
      "documentNotAvailable": "Document",
      "notAvailable": "not available"
    },

      "amountToPaye": {
      "totalUnpaid": "Total Amount Still Unpaid",
      "outstandingDescription": "This is the sum of all unpaid amounts for auctions you have won.",
      "car": "Car",
      "details": "Details",
      "status": "Status",
      "payment": "Payment",
      "actions": "Actions",
      "paymentDeadline": "Payment Due",
    ...
    "stockId": "Stock ID",
    "viewBids": "View Bids",
    "viewSaleProcess": "View Sale Process",
    "viewListing": "View Listing",
    "yourBid": "Your Bid",
    "broker": "Broker",
    "note": "Note",
    "viewBidDetails": "View Bid Details",
      "favorited": "Favorited",
  ...
  "dueAt": "Fällig am",
  "uploadFinalInvoice": "Endrechnung & Dokumente hochladen",
  "finalInvoicePDF": "Endrechnung (PDF)",
  "carDocumentsPDF": "Fahrzeugdokumente (PDF)",
  "ascriptionCode": "Zuordnungscode",
  "uploadAll": "Alles hochladen",
  "uploading": "Wird hochgeladen...",
  "fillAllFields": "Bitte alle Felder ausfüllen und Dateien hochladen.",
  "uploadSuccess": "Dokumente erfolgreich hochgeladen!",
  "paymentStatus": "Zahlungsstatus",
  "invoicePaid": "Rechnung wurde bezahlt",
  "pendingPayment": "Zahlung ausstehend von Car Network Europe",
  "paid": "Bezahlt",
  "paymentDueIn48h": "Zahlung fällig innerhalb von 48 Stunden nach Fahrzeuglieferung.",
  "autoArchiveNote": "Dieser Auftrag wird automatisch 24 Stunden nach Lieferung archiviert, wenn der Käufer keinen Schaden meldet.",
     "award": {
...
"analytics": "Analyse & Berichte",
      ...
      "blocks": {
      "myAuctions": "Meine Auktionen",
      "myAuctionsDesc": "Direkte Übersicht aller derzeit online gelisteten Fahrzeuge.",
      "myAuctionsBids": "Zeige die Gebote pro Fahrzeug.",
      "myAuctionsWarning": "⚠️ Nicht das gleiche Layout wie im \"Kaufen\"-Bereich verwenden.",
      "totalVehicles": "Gesamtzahl Fahrzeuge",
      "myBids": "Meine Gebote",
      "myBidsDesc": "Übersicht aller Fahrzeuge, auf die das Unternehmen Gebote abgegeben hat.",
      "myBidsPerBranch": "Muss pro Niederlassung, nicht pro Händlergruppe angezeigt werden.",
      "totalBids": "Gesamtzahl Gebote",
      "myFavorites": "Meine Favoriten",
      "myFavoritesDesc": "Übersicht aller als Favoriten markierten Fahrzeuge.",
      "totalFavorites": "Gesamtzahl Favoriten",
      "orderHistory": "Bestellverlauf",
      "orderHistoryDesc": "Übersicht aller Käufe.",
      "viewInvoices": "Rechnungen ansehen.",
      "viewAttachedDocs": "Angehängte Dokumente ansehen (Dateinamen bearbeitbar).",
      "totalPurchases": "Gesamtzahl Käufe",
      "amountToPay": "Zu zahlender Betrag (Gewonnene Auktionen)",
      "amountToPayDesc": "Übersicht gewonnener Auktionen.",
      "amountToPayUnpaid": "Zeigt den Gesamtbetrag, der noch nicht bezahlt, aber bereits gewonnen wurde.",
      "totalAmountToPay": "Gesamtzahl zu zahlender Betrag",
      "amountToReceive": "Zu erhaltender Betrag (Verkaufte Fahrzeuge)",
      "amountToReceiveDesc": "Übersicht verkaufter Fahrzeuge.",
      "amountToReceiveOutstanding": "Zeigt den Gesamtbetrag, der noch ausgezahlt werden muss.",
      "totalAmountToReceive": "Gesamtzahl zu erhaltender Betrag"
    },
       
      "amountToReceive": {
      "totalOutstanding": "Gesamtbetrag noch zu erhalten",
      "outstandingDescription": "Dies ist die Summe aller Beträge, die für von Ihnen verkaufte Fahrzeuge noch zu erhalten sind.",
      "car": "Auto",
      "details": "Details",
      "status": "Status",
      "payout": "Auszahlung",
      ...
      "statusa": {
        "paid": "Bezahlt",
        "pending": "Ausstehend",
        "awaitingInvoice": "Warten auf Rechnung"
      },
      "viewPayout": "Auszahlung anzeigen",
      "resultsFound": "verkaufte Fahrzeuge gefunden",
      "noSalesDescription": "Sie haben noch keine Fahrzeuge verkauft oder alle Auszahlungen sind abgeschlossen."
    }, 

    "goToMyAuctions": "Zu Meine Auktionen navigieren...",
    "goToMyBids": "Zu Meine Gebote navigieren...",
    "goToMyFavorites": "Zu Meine Favoriten navigieren...",
    "goToOrderHistory": "Zu Bestellverlauf navigieren...",
    "goToAmountToPay": "Zu Zu zahlender Betrag navigieren...",
    "goToAmountToReceive": "Zu Zu erhaltender Betrag navigieren...",
    "backToOverview": "Zurück zur Übersicht",
    "downloadReport": "Bericht herunterladen",
    "companyProfile": "Firmenprofil & Neueste Nachrichten",
    "manageProfile": "Verwalten Sie Ihre Geschäftsdaten und bleiben Sie mit Plattformnachrichten auf dem Laufenden.",
    "filter": {
      "title":"Filter",
      "status": "Status",
      ...
      "mileageFrom": "Kilometerstand von (km)",
      "mileageTo": "Kilometerstand bis (km)",
      "mileage": "Kilometerstand",
    ...
    "sort": {
      "newest": "Neueste",
      "oldest": "Älteste",
      "mileageLow": "Kilometerstand: Niedrig zu Hoch",
      "mileageHigh": "Kilometerstand: Hoch zu Niedrig",
       "bidAmountHigh": "Gebotsbetrag: Hoch zu Niedrig",
      "bidAmountLow": "Gebotsbetrag: Niedrig zu Hoch",
       "priceHigh": "Preis: Hoch zu Niedrig",
      "priceLow": "Preis: Niedrig zu Hoch",
         "dateDelivered": "Lieferdatum",
      "dateClosed": "Abschlussdatum",
      "deadlineSoonest": "Zahlungsfrist: Bald",
      "deadlineLatest": "Zahlungsfrist: Später",
      "amountHigh": "Betrag: Hoch zu Niedrig",
      "amountLow": "Betrag: Niedrig zu Hoch",
      "dateSoldNewest": "Verkaufsdatum: Neueste",
      "dateSoldOldest": "Verkaufsdatum: Älteste",  
    },
      "amountToPaye": {
      "totalUnpaid": "Gesamtbetrag noch unbezahlt",
      "outstandingDescription": "Dies ist die Summe aller unbezahlten Beträge für von Ihnen gewonnene Auktionen.",
      "car": "Auto",
      "details": "Details",
      "status": "Status",
      ...
      "payment": "Zahlung",
      "actions": "Aktionen",
      "paymentDeadline": "Zahlung fällig",
    ...
    "viewVehicleDetails": "Details ansehen",
    "viewAuctionDetails": "Details ansehen",
    "activeFilters": "Aktive Filter",
    "resultsFound": "Ergebnisse gefunden",
    "noResults": "Keine Fahrzeuge gefunden",
    "noResultsDescription": "Versuchen Sie, Ihre Filter zu ändern",
    "resetFilters": "Filter zurücksetzen",
    "auctionEnds": "Endet",
    "highestBid": "Höchstgebot",
    "bids": "Gebote",
    "stockId": "Lager-ID",
    "viewBids": "Gebote ansehen",
    "viewSaleProcess": "Verkaufsprozess ansehen",
    "viewListing": "Anzeige ansehen",
    "yourBid": "Ihr Gebot",
    "broker": "Makler",
    "note": "Notiz",
    "viewBidDetails": "Gebotsdetails ansehen",
    "clearAll":"clearAll",
    "favorited": "Favorisiert",
    "removeFromFavorites": "Aus Favoriten entfernen",
     "orderHistory": {
      "noHistoryDescription": "Es liegen noch keine abgeschlossenen Käufe vor.",
      "car": "Auto",
      "details": "Details",
      "status": "Status",
      "buyer": "Käufer",
      ...
      "awardedTo": "Zugesprochen an",
      "proformaInvoice": "Proforma-Rechnung",
      "finalInvoice": "Endrechnung",
      "ascriptionCode": "Zuschreibungscode",
      "view": "Ansehen",
      "invoiceNotAvailable": "Rechnung",
      "documentNotAvailable": "Dokument",
  ...
  nl: {
     "backToBiddings": "Terug naar biedingen",
  "invoiceManagement": "Factuurbeheer",
  "awardedTo": "Toegekend aan",
  "proformaInvoice": "Proforma factuur",
  "issuedByCNE": "Uitgegeven door Car Network Europe",
  "download": "Downloaden",
  ...
  "dueAt": "Vervaldatum",
  "uploadFinalInvoice": "Eindfactuur & documenten uploaden",
  "finalInvoicePDF": "Eindfactuur (PDF)",
  "carDocumentsPDF": "Autodocumenten (PDF)",
  "ascriptionCode": "Toewijzingscode",
  "uploadAll": "Alles uploaden",
  "uploading": "Bezig met uploaden...",
  "fillAllFields": "Vul alle velden in en upload bestanden.",
  "uploadSuccess": "Documenten succesvol geüpload!",
  "paymentStatus": "Betaalstatus",
  "invoicePaid": "Factuur is betaald",
  "pendingPayment": "Betaling in afwachting van Car Network Europe",
  "paid": "Betaald",
  "paymentDueIn48h": "Betaling verschuldigd binnen 48 uur na levering van de auto.",
  "autoArchiveNote": "Deze order wordt automatisch 24 uur na levering gearchiveerd als de koper geen schade meldt.",
    "award": {
...
"analytics": "Analyse & Rapporten",
    ...
    "blocks": {
      "myAuctions": "Mijn Veilingen",
      "myAuctionsDesc": "Direct overzicht van alle momenteel online vermelde voertuigen.",
      "myAuctionsBids": "Toon de biedingen per voertuig.",
      "myAuctionsWarning": "⚠️ Gebruik niet dezelfde lay-out als in de \"Kopen\" sectie.",
      "totalVehicles": "Totaal Aantal Voertuigen",
      "myBids": "Mijn Biedingen",
      "myBidsDesc": "Overzicht van alle voertuigen waarop het bedrijf heeft geboden.",
      "myBidsPerBranch": "Moet per vestiging worden getoond, niet per dealer groep.",
      "totalBids": "Totaal Aantal Biedingen",
      "myFavorites": "Mijn Favorieten",
      "myFavoritesDesc": "Overzicht van alle als favorieten gemarkeerde auto's.",
      "totalFavorites": "Totaal Aantal Favorieten",
      "orderHistory": "Bestelgeschiedenis",
      "orderHistoryDesc": "Overzicht van alle aankopen.",
      "viewInvoices": "Facturen bekijken.",
      "viewAttachedDocs": "Bekijk bijgevoegde documenten (bestandsnamen bewerkbaar).",
      "totalPurchases": "Totaal Aantal Aankopen",
      "amountToPay": "Te betalen bedrag (Gewonnen veilingen)",
      "amountToPayDesc": "Overzicht van gewonnen veilingen.",
      "amountToPayUnpaid": "Toon het totale bedrag dat nog niet is betaald, maar al is gewonnen.",
      "totalAmountToPay": "Totaal te betalen bedrag",
      "amountToReceive": "Te ontvangen bedrag (Verkochte auto's)",
      "amountToReceiveDesc": "Overzicht van verkochte voertuigen.",
      "amountToReceiveOutstanding": "Toon het totale bedrag dat nog moet worden uitbetaald.",
      "totalAmountToReceive": "Totaal te ontvangen bedrag"
    },
    "goToMyAuctions": "Navigeren naar Mijn Veilingen...",
    "goToMyBids": "Navigeren naar Mijn Biedingen...",
    "goToMyFavorites": "Navigeren naar Mijn Favorieten...",
    "goToOrderHistory": "Navigeren naar Bestelgeschiedenis...",
    "goToAmountToPay": "Navigeren naar Te betalen bedrag...",
    "goToAmountToReceive": "Navigeren naar Te ontvangen bedrag...",
    "backToOverview": "Terug naar Overzicht",
    "downloadReport": "Rapport downloaden",
    "companyProfile": "Bedrijfsprofiel & Laatste Nieuws",
    "manageProfile": "Beheer uw bedrijfsinformatie en blijf op de hoogte van platformnieuws.",
    ...
    "filter": {
      ...
      "model": "Model",
      "allModels": "Alle Modellen",
      "selectMakeFirst": "Selecteer eerst Merk",
      "mileageFrom": "Kilometerstand van (km)",
      "mileageTo": "Kilometerstand tot (km)",
      "mileage": "Kilometerstand",
      "sortBy": "Sorteren op",
      "clearAll": "Alles wissen",
       },
    ...
    "sort": {
      "newest": "Nieuwste",
      "oldest": "Oudste",
      "mileageLow": "Kilometerstand: Laag naar Hoog",
      "mileageHigh": "Kilometerstand: Hoog naar Laag",
         "bidAmountHigh": "Biedingsbedrag: Hoog naar Laag",
      "bidAmountLow": "Biedingsbedrag: Laag naar Hoog",
      "priceHigh": "Prijs: Hoog naar Laag",
      "priceLow": "Prijs: Laag naar Hoog",
       "dateDelivered": "Datum Geleverd",
      "dateClosed": "Datum Afgerond",
            "deadlineSoonest": "Betaaltermijn: Spoedig",
      "deadlineLatest": "Betaaltermijn: Later",
      "amountHigh": "Bedrag: Hoog naar Laag",
      "amountLow": "Bedrag: Laag naar Hoog",
      "dateSoldNewest": "Verkoopdatum: Nieuwste",
      "dateSoldOldest": "Verkoopdatum: Oudste",
    },
   "amountToPaye": {
      "totalUnpaid": "Totaal nog te betalen bedrag",
      "outstandingDescription": "Dit is de som van alle onbetaalde bedragen voor veilingen die u heeft gewonnen.",
      "car": "Auto",
      "details": "Details",
      "status": "Status",
      "payment": "Betaling",
      "actions": "Acties",
      "paymentDeadline": "Betaling verschuldigd",
      "amountOwed": "Verschuldigd bedrag",
      "paymentStatus": "Betalingsstatus",
      "statusa": {
        "paid": "Betaald",
        "pending": "In afwachting",
        "awaitingInvoice": "Wachten op factuur"
      },
      "makePayment": "Betaling doen",
      "noAuctionsDescription": "U heeft nog geen veilingen gewonnen of alle betalingen zijn voldaan."
    },

     "amountToReceive": {
      "totalOutstanding": "Totaal te ontvangen bedrag",
      "outstandingDescription": "Dit is de som van alle bedragen die nog moeten worden ontvangen voor voertuigen die u heeft verkocht.",
      "car": "Auto",
      "details": "Details",
      "status": "Status",
      "payout": "Uitbetaling",
      ...
      "viewPayout": "Uitbetaling bekijken",
      "resultsFound": "verkochte voertuigen gevonden",
      "noSalesDescription": "U heeft nog geen voertuigen verkocht of alle uitbetalingen zijn verwerkt."
    },
        
    "viewVehicleDetails": "Lijst bekijken",
    "viewAuctionDetails": "Details bekijken",
   "activeFilters": "Actieve Filters",
    "resultsFound": "resultaten gevonden",
    "noResults": "Geen auto's gevonden",
    "noResultsDescription": "Probeer uw filters aan te passen",
    "resetFilters": "Filters resetten",
    "auctionEnds": "Eindigt",
    "highestBid": "Hoogste bod",
    "bids": "Biedingen",
    "stockId": "Voorraad ID",
    "viewBids": "Biedingen bekijken",
    "viewSaleProcess": "Verkoopproces bekijken",
    "viewListing": "Lijst bekijken",
    "yourBid": "Uw bod",
    "broker": "Makelaar",
    "note": "Notitie",
    "viewBidDetails": "Biddetails bekijken",
    "clearAll":"Alles leeggemaakt",
        "favorited": "Favoriet",
    "removeFromFavorites": "Verwijderen uit favorieten",
 "orderHistory": {
      "noHistoryDescription": "Er zijn nog geen voltooide aankopen.",
      "car": "Auto",
      "details": "Details",
      "status": "Status",
      "buyer": "Koper",
      ...
      "ascriptionCode": "Toeschrijvingscode",
      "view": "Bekijken",
      "invoiceNotAvailable": "Factuur",
      "documentNotAvailable": "Document",
